             ...
             <div class="row">
                 <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <h2 class="header-title" style="text-align: center; font-size: 25px">{{ __('Woman Collection') }}</h2>
                                         ...
                                         <tr>
                                            ...
                                            <td>{{ $product->inventory->quantity }}</td>
                                             ...
                                             <td>
                                                ...
                                                onclick="document.getElementById('product-{{ $product->id }}').submit()"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
